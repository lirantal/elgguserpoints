<?php
	...
	*/
    ...
    $form .= elgg_view('input/pulldown', array(
                    'internalname' => 'params[profile_display]',
    ...
    $form .= elgg_view('input/text', array('internalname' => "params[upperplural]", 'value' => $upperplural));
    $form .= "<br><br>";

    $form .= "<b>" . elgg_echo('elggx_userpoints:settings:lowerplural') . "</b>";
    $form .= elgg_view('input/text', array('internalname' => "params[lowerplural]", 'value' => $lowerplural));
    $form .= "<br><br>";

    $form .= "<b>" . elgg_echo('elggx_userpoints:settings:lowersingular') . "</b>";
    $form .= elgg_view('input/text', array('internalname' => "params[lowersingular]", 'value' => $lowersingular));
    $form .= "<br><br>";

    $form .= "<b>" . elgg_echo('elggx_userpoints:settings:toppoints:name') . "</b>";
    $form .= elgg_view('input/text', array('internalname' => "params[toppoints_name]", 'value' => $toppoints_name));
    $form .= "<br><br>";

    $form .= "<b>" . elgg_echo('elggx_userpoints:settings:toppoints:num') . "</b>";
    $form .= elgg_view('input/text', array('internalname' => "params[numtoppoints]", 'value' => $numtoppoints));
    $form .= "<br><br>";

    $form .= "<b>" . elgg_echo('elggx_userpoints:settings:displaymessage') . "</b>";
    $form .= elgg_view('input/pulldown', array(
                    'internalname' => 'params[displaymessage]',
                    'options_values' => array('1' => 'Yes', '0' => 'No'),
    ...
    $form .= elgg_view('input/pulldown', array(
                    'internalname' => 'params[expire_after]',
                    'options_values' => array(
