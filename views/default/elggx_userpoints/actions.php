<?php
    ...
    $plugin = find_plugin_settings('elggx_userpoints');
  ...
  <table>
    ...
    <tr><td colspan="2"><hr /><br /></td></tr>
     ...
     <tr>
        ...
        <td><?php echo elgg_view('input/text', array('internalname' => "params[blog]", 'value' => $plugin->blog)); ?></td>
    </tr>
    ...
    <tr>
        ...
        <td><?php echo elgg_view('input/text', array('internalname' => "params[generic_comment]", 'value' => $plugin->generic_comment)); ?></td>
    </tr>
    ...
    <tr>
        ...
        <td><?php echo elgg_view('input/text', array('internalname' => "params[riverpost]", 'value' => $plugin->riverpost)); ?></td>
    </tr>
    ...
    <tr>
        ...
        <td><?php echo elgg_view('input/text', array('internalname' => "params[thewire]", 'value' => $plugin->thewire)); ?></td>
    </tr>
    ...
    <tr>
        ...
        <td><?php echo elgg_view('input/text', array('internalname' => "params[poll]", 'value' => $plugin->poll)); ?></td>
    </tr>
    ...
    <tr>
        ...
        <td><?php echo elgg_view('input/text', array('internalname' => "params[vote]", 'value' => $plugin->vote)); ?></td>
    </tr>
    ...
    <tr>
        ...
        <td><?php echo elgg_view('input/text', array('internalname' => "params[group]", 'value' => $plugin->group)); ?></td>
    </tr>
    ...
    <tr>
        ...
        <td><?php echo elgg_view('input/text', array('internalname' => "params[group_topic_post]", 'value' => $plugin->group_topic_post)); ?></td>
    </tr>
    ...
    <tr>
        ...
        <td><?php echo elgg_view('input/text', array('internalname' => "params[profileupdate]", 'value' => $plugin->profileupdate)); ?></td>
    </tr>
    ...
    <tr>
        ...
        <td><?php echo elgg_view('input/text', array('internalname' => "params[page_top]", 'value' => $plugin->page_top)); ?></td>
    </tr>
    ...
    <tr>
        ...
        <td><?php echo elgg_view('input/text', array('internalname' => "params[ad]", 'value' => $plugin->ad)); ?></td>
    </tr>
    ...
    <tr>
        ...
        <td><?php echo elgg_view('input/text', array('internalname' => "params[izap_videos]", 'value' => $plugin->izap_videos)); ?></td>
    </tr>
    ...
    <tr>
        ...
        <td><?php echo elgg_view('input/text', array('internalname' => "params[upload_photo]", 'value' => $plugin->upload_photo)); ?></td>
    </tr>
    ...
    <tr>
        ...
        <td><?php echo elgg_view('input/text', array('internalname' => "params[phototag]", 'value' => $plugin->phototag)); ?></td>
    </tr>
    ...
    <tr>
        ...
        <td><?php echo elgg_view('input/text', array('internalname' => "params[fivestar]", 'value' => $plugin->fivestar)); ?></td>
    </tr>
    ...
    <tr>
        ...
        <td><?php echo elgg_view('input/text', array('internalname' => "params[recommendation]", 'value' => $plugin->recommendation)); ?></td>
    </tr>
    ...
    <tr>
        ...
        <td><?php echo elgg_view('input/pulldown', array(
                         'internalname' => 'params[recommendations_approve]',
    ...
    <tr>
        ...
        <td><?php echo elgg_view('input/text', array('internalname' => "params[login]", 'value' => $plugin->login)); ?></td>
    </tr>
    ...
    <tr>
        ...
        <td><?php echo elgg_view('input/text', array('internalname' => "params[login_interval]", 'value' => $plugin->login_interval)); ?></td>
    </tr>
    ...
    <tr>
        ...
        <td><?php echo elgg_view('input/text', array('internalname' => "params[invite]", 'value' => $plugin->invite)); ?></td>
    </tr>
    ...
    <tr>
        ...
        <td><?php echo elgg_view('input/pulldown', array(
                             'internalname' => 'params[verify_email]',
                             'options_values' => array('1' => 'Yes', '0' => 'No'),
    ...
    <tr>
        ...
        <td><?php echo elgg_view('input/pulldown', array(
                             'internalname' => 'params[require_registration]',
                             'options_values' => array('1' => 'Yes', '0' => 'No'),
    ...
    <tr>
        ...
        <td><?php echo elgg_view('input/pulldown', array(
                    'internalname' => 'params[expire_invite]',
