<?php
    ...
    $html .= "<th width=\"20%\"><b>".get_plugin_setting('upperplural', 'elggx_userpoints')."</b></th>";
    $html .= "<th width=\"10%\"><b>".elgg_echo('elggx_userpoints:action')."</b></tr>";
    $html .= "<tr><td colspan=3><hr></td></tr>";

    foreach ($entities as $entity) {

        $html .= "<tr><td><a href=\"{$vars['url']}mod/elggx_userpoints/admin.php?tab=detail&user_guid={$entity->guid}\">{$entity->name}</a></td>";
        $html .= "<td><a href=\"{$vars['url']}mod/elggx_userpoints/admin.php?tab=detail&user_guid={$entity->guid}\">{$entity->userpoints_points}</a></td>";
        $html .= "<td>" . elgg_view("output/confirmlink", array(
                              ...
                              'confirm' => sprintf(elgg_echo('elggx_userpoints:reset:confirm'), get_plugin_setting('lowerplural', 'elggx_userpoints'), $entity->name)
                          ));
        $html .= "</td></tr>";
